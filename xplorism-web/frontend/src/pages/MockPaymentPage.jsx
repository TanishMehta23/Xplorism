  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const bookingConfirm = {
        ...
        checkIn: booking.checkIn,
        checkOut: booking.checkOut,
        price: booking.finalLocalPrice || booking.rawUSDPrice,
        currencySymbol: booking.bookingHotel?.currencySymbol || booking.currency?.symbol || '₹',
          ...
          <div className="rounded-xl p-4 bg-[var(--bg-primary)] border mb-4" style={{ borderColor: 'var(--border-primary)' }}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-[var(--text-secondary)]">{booking.roomType} • {booking.nights || 1} Night(s)</div>
              </div>
              <div className="text-right">
                <div className="text-xs text-[var(--text-secondary)]">Total Stay Amount</div>
