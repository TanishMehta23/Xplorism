      ...
      <nav className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between border-b flex-nowrap ${isDark ? 'border-slate-900' : 'border-slate-100'}`}>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 shrink-0">
          ...
          {isAuthenticated ? (
            <Link
              to="/dashboard"
              className="px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-rose-500 hover:bg-rose-600 shadow-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-95"
            >
              {t('go_to_dashboard')}
            </Link>
          ) : (
            <div className="flex items-center space-x-1 sm:space-x-3">
              ...
              <button
                ...
                className="px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-rose-500 hover:bg-rose-600 shadow-sm transition-all duration-200 hover:-translate-y-0.5 active:scale-95 cursor-pointer whitespace-nowrap"
              >
                {t('sign_up')}
              </button>
            </div>
      ...
      <header className="relative z-10 max-w-5xl mx-auto px-6 pt-20 pb-8 text-center flex flex-col items-center">
        ...
        >
          {isAuthenticated ? (
            <Link
              to="/dashboard"
              className="px-8 py-3.5 rounded-xl font-bold text-sm text-white bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-500/25 transition-all duration-200 hover:-translate-y-0.5 active:scale-95"
            >
            ...
            <button
              ...
              className="px-8 py-3.5 rounded-xl font-bold text-sm text-white bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-500/25 transition-all duration-200 hover:-translate-y-0.5 active:scale-95 cursor-pointer"
            >
          ...
          <div className={`lg:col-span-5 border rounded-3xl p-6 shadow-sm min-h-[420px] lg:min-h-[450px] flex flex-col justify-between transition-colors duration-300 ${
            ...
            <div className="mt-8 pt-4 border-t border-slate-100 dark:border-slate-800">
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-rose-500 hover:bg-rose-600 text-white font-bold text-xs transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer shadow-md shadow-rose-500/20 active:scale-[0.98]"
              >
