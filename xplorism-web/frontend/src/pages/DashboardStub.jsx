...
import {
  ...
  Sun, Cloud, CloudRain, Snowflake, Wind, Heart
} from 'lucide-react';
            ...
            >
              ...
              <div className="flex items-center justify-end space-x-3">
                <button
                  ...
                  className="px-4 py-2 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-bold transition cursor-pointer shadow-sm"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition cursor-pointer shadow-sm"
                >
                  Delete
                </button>
              </div>
