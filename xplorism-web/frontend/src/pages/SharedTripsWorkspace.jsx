      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10 min-h-[85vh] pb-24">
        ...
        <div className="mb-6 sm:mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6 text-left">
          <div>
            ...
            <p className="text-slate-555 dark:text-slate-400 text-xs sm:text-sm mt-1.5 sm:mt-2 max-w-2xl leading-relaxed">
        ...
        {/* Workspace Info Card */}
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-8 mb-6 sm:mb-10 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 relative overflow-hidden shadow-xl shadow-slate-100/50 dark:shadow-none">
          ...
          <div className="flex items-start space-x-3 sm:space-x-4 w-full relative">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-555 dark:text-slate-400 text-xs sm:text-sm mt-1.5 sm:mt-2 leading-relaxed font-medium">
            ...
            <AnimatePresence>
              {trips.map((trip, idx) => (
                <motion.div
                  ...
                  className="group bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 hover:border-rose-400 dark:hover:border-rose-500 rounded-2xl sm:rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-350 cursor-pointer flex flex-col justify-between"
                >
                  <div>
                    {/* Cover image header */}
                    <div className="relative h-36 sm:h-44 w-full overflow-hidden">
                      ...
                      {/* Host Tag Overlay */}
                      <div className="absolute top-2.5 sm:top-4 left-2.5 sm:left-4 flex items-center space-x-1.5 z-10 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full text-[8.5px] sm:text-[9px] font-black uppercase tracking-wider bg-slate-900/80 text-white backdrop-blur-md border border-white/10 shadow-lg">
                      ...
                      {trip.userId === user?.id && (
                        <button
                          ...
                          className="absolute top-2.5 sm:top-4 right-2.5 sm:right-4 h-7 w-7 sm:h-8 sm:w-8 rounded-xl bg-white/90 hover:bg-rose-600 text-slate-700 hover:text-white transition-all duration-200 shadow-md cursor-pointer border border-slate-200/50 flex items-center justify-center active:scale-90 z-20"
                    ...
                    <div className="p-4 sm:p-6">
                      <h3 className="text-base sm:text-lg font-black text-slate-800 dark:text-white group-hover:text-rose-500 transition-colors line-clamp-1 mb-2 sm:mb-3">
                        {trip.destination}
                      </h3>

                      <div className="space-y-2 sm:space-y-2.5">
                        <div className="flex items-center text-xs text-slate-550 dark:text-slate-400 space-x-2 font-semibold">
                          <Calendar className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-rose-505 shrink-0" />
                          <span>{formatDate(trip.startDate)} - {formatDate(trip.endDate)}</span>
                        </div>
                        <div className="flex items-center text-xs text-slate-550 dark:text-slate-400 space-x-2 font-semibold">
                          <Compass className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-rose-505 shrink-0" />
                  ...
                  {/* Card Footer */}
                  <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800/80 px-4 sm:px-6 py-3 sm:py-4 bg-slate-50/50 dark:bg-slate-900/20">
                    <div className="flex items-center -space-x-1.5 sm:-space-x-2">
                      <div
                        className="h-6 w-6 sm:h-7 sm:w-7 rounded-full bg-rose-500 text-white border-2 border-white dark:border-slate-900 flex items-center justify-center text-[9px] sm:text-[10px] font-black uppercase shadow-sm select-none"
                      ...
                      {trip.travelers > 1 && (
                        <div
                          className="h-6 w-6 sm:h-7 sm:w-7 rounded-full bg-slate-200 dark:bg-slate-800 border-2 border-white dark:border-slate-900 text-slate-650 dark:text-slate-450 flex items-center justify-center text-[8px] sm:text-[9px] font-black shadow-sm select-none"
                    ...
                    <span className="text-[11px] sm:text-xs font-black text-rose-500 group-hover:translate-x-1 transition-transform flex items-center space-x-1">
