...
export default function LoginPage() {
  ...
  }, [loginWithGoogle, clientId, view, isNative]);
                  ...
                  <>
                    ...
                    {isNative ? (
                      <button
                        ...
                        disabled={loading}
                        className="w-full py-3 px-4 rounded-xl border border-slate-700/60 bg-slate-900/60 hover:bg-slate-800/80 transition-all flex items-center justify-center space-x-3 text-xs font-semibold text-slate-200 shadow-sm cursor-pointer disabled:opacity-50"
                      >
